...
import { Button, Card , H3} from 'ui-neumorphism'
...
class App extends Component {
    ...
    fileSubmit = async () => {
        ...
        const wait = this.props.history.push(`/results/${this.state.user_id}`);
    ...
    render() {
        return (
            <header className="App-header">
                <Card className ="title" elevation={5} width={700} height={100}>
                    <H3 className = "title_text">CHEATING CHEATSHEETS</H3>
                </Card>
                <input
                    ref="fileInput"
                    type='file'
